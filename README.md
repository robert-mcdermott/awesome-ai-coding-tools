...
- [Collomia](https://github.com/robert-mcdermott/collomia) - Provider-neutral terminal coding agent with a beautiful TUI that routes every model-proposed action through layered permissions, command analysis, OS sandboxing, network controls, and an audit ledger.
